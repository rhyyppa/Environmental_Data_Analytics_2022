...
```{r}
<<<<<<< HEAD
Plot_text <- ggplot(data=data.frame(x=0,y=0))+
=======
library(ggplot2)
Plot_text <-
...
# refer to video to understand why this is not working 
...
# facet wrap looks at all the unique values in the column and 
