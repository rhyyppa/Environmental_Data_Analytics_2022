...
# breaking up the same plot into multiple lines of code
O3plot <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone))
print(O3plot)

# Fix this code, you need to specify color outsie of the paranthesis with variables, b/c otherwise, R is reading color in as a variable
...
# Separate plot with facets, use facets to separate out your graph into multiple plots for better visualization
PMplot.faceted <-
...
# this is a poor visuzliaztion of the data set because you have two outliers --> adjust axes
